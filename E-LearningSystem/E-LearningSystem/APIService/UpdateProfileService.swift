...
class UpdateProfileService {
    ...
    func updateProfile(user: UserUpdate, success: (User) -> Void, failure: (String) -> Void) {
        ...
        manager.request(.PATCH, linkJson.jsonUpdateProfile, parameters: parameters, encoding: ParameterEncoding.URL, headers: headers).responseJSON(completionHandler: { (response) in
